                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="jurusan" id="jurusan">
                                ...
                                <option value="SISTIM INFORMASI" <?php if ($jurusan == "SISTIM INFORMASI") echo "selected" ?>>SISTIM INFORMASI</option>
                                <option value="BISNIS DIGITAL" <?php if ($jurusan == "BISNIS DIGITAL") echo "selected" ?>>BISNIS DIGITAL</option>
                                <option value="MANAGEMENT KOMPUTER" <?php if ($jurusan == "MANAGEMENT KOMPUTER") echo "selected" ?>>MANAGEMENT KOMPUTER</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
